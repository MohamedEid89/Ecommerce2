...
<body class=" layout-boxed">
        ...
        <div id="content" class="main-content">
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © <span class="dynamic-year">2023</span> <a target="_blank" href="#">Mohamed Eid</a>, All rights reserved.</p>
                </div>
    ...
    <script src="{{ asset('src/bootstrap/js/bootstrap.bundle.min.j') }}s"></script>
