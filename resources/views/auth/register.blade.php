                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control add-billing-address-input" id="name" type="name" name="name" value="{{ old('name') }}"  required autocomplete="name">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="password" type="password" name="password" value="{{ old('password') }}"  required autocomplete="password">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input  class="form-control" id="password_confirmation" type="password" name="password_confirmation"  required autocomplete="password_confirmation">
