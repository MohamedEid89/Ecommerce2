                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-4">
                                            ...
                                            <input  id="password"  type="password" name="password" value="{{ old('password') }}"  required autofocus autocomplete="password"  class="form-control">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <div class="form-check form-check-primary form-check-inline">
                                                <input class="form-check-input me-3" id="remember_me" type="checkbox"  name="remember">
                                ...
                                <div class="col-12">
                                    <div class="text-center">
                                        <p class="mb-0">Forgot your password? <a href="{{ route('password.request') }}" class="text-warning">Forgot password</a></p>
                                    </div>
                                </div>
                            </div>
